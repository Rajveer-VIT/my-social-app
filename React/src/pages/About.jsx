    ...
    <div className="min-h-screen bg-gradient-to-r from-blue-50 to-indigo-100 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-2xl p-8">
        ...
        <div className="space-y-6 text-gray-700">
          ...
          <div className="mt-8">
            <h2 className="text-xl md:text-2xl font-bold text-gray-900 mb-4">Our Team</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="bg-blue-50 p-6 rounded-lg shadow-md">
                <h3 className="text-lg md:text-xl font-semibold text-blue-600">Rajveer Singh Khinchi</h3>
                <p className="text-sm md:text-gray-600">Developer & Designer</p>
                <p className="mt-2 text-sm md:text-gray-700">
          ...
          <div className="mt-8">
            <h2 className="text-xl md:text-2xl font-bold text-gray-900 mb-4">Our Story</h2>
            <p className="text-base md:text-lg leading-relaxed">
